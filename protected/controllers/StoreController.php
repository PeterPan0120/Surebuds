...
class StoreController extends CController
{
	...
	{	
	    ...
	    $_SESSION['confirm_order_data']['city'] = Yii::app()->functions->getCityFromId(explode("_", $_SESSION['confirm_order_data']['city'])[0])[0]['city']; //get city name with id in delivery_fee table
