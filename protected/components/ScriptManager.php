...
class ScriptManager
{
	...
	{				
        ...
        $cs->registerScriptFile("/assets/js/jquery-ui.js"
		...
		,CClientScript::POS_END); 
		$cs->registerScriptFile($baseUrl."/assets/vendor/fancybox/source/jquery.fancybox.js"
		,CClientScript::POS_END); 
		...
		,CClientScript::POS_END); 
		$cs->registerScriptFile($baseUrl."/assets/vendor/intel/build/js/intlTelInput.js"
		,CClientScript::POS_END); 
		...
		$cs->registerScriptFile($baseUrl."/assets/js/k_mapbox.js"
		,CClientScript::POS_END); 
	...
	public static function registerAllCSSFiles($config=array())
	{
		...
		$cs->registerCssFile($baseUrl."/assets/vendor/iCheck/skins/minimal/_all.css");
		$cs->registerCssFile($baseUrl."/assets/vendor/iCheck/skins/square/_all.css");
		$cs->registerCssFile($baseUrl."/assets/vendor/iCheck/skins/flat/_all.css");
		$cs->registerCssFile($baseUrl."/assets/vendor/iCheck/skins/line/_all.css");
		$cs->registerCssFile($baseUrl."/assets/vendor/iCheck/skins/polaris/polaris.css");
		$cs->registerCssFile($baseUrl."/assets/vendor/iCheck/skins/futurico/futurico.css");
		$cs->registerCssFile($baseUrl."/assets/vendor/chosen/chosen.css");
		$cs->registerCssFile($baseUrl."/assets/vendor/fancybox/source/jquery.fancybox.css");
		...
		$cs->registerCssFile($baseUrl.'/assets/css/store-v2.css');
		$cs->registerCssFile($baseUrl.'/assets/css/responsive.css');
