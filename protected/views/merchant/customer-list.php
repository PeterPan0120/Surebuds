...
<a href="<?php echo Yii::app()->request->baseUrl; ?>/merchant/customerlist" class="uk-button"><i class="fa fa-list"></i> <?php echo Yii::t("default","List")?></a>
...
<input type="hidden" name="action" id="action" value="merchantCustomerList">
