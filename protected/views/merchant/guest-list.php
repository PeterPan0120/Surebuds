...
<a href="<?php echo Yii::app()->request->baseUrl; ?>/merchant/guestlist" class="uk-button"><i class="fa fa-list"></i> <?php echo Yii::t("default","List")?></a>

<a class="export_btn uk-button" rel="rptGuestList" href="javascript:;"><?php echo t("Export to Mailchimp mailing list")?></a>
