...
<div class="col-md-6 border" style="padding-left:10px;padding-right:10px;">
   <div class="box-grey">
       <a href="javascript:;" 
     class="dsktop inline rounded3 menu-item <?php echo $val_item['not_available']==2?"item_not_available":''?>"
     ...
     data-category_id="<?php echo $val['category_id']?>"
      >
       ...
       <a href="javascript:;" 
     class="mbile inline rounded3 menu-item <?php echo $val_item['not_available']==2?"item_not_available":''?>"
     rel="<?php echo $val_item['item_id']?>"
     data-single="<?php echo $val_item['single_item']?>" 
     <?php echo $atts;?>
     data-category_id="<?php echo $val['category_id']?>"
