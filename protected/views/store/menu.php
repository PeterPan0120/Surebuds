     ...
     <div class="col-md-8 border menu-left-content">
		...
		<ul id="cat_tabs">
            <?php foreach ($menu as $val):?>
                <li>
                    <a href="javascript:;" class="category-child relative goto-category" data-id="cat-<?php echo $val['category_id']?>" style="text-decoration: none;">
        		      <span>
