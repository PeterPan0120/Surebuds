...
app.controller('employeeController', [
    ...
    function ($scope, $rootScope, $window, cookie, uiGridConstants, hrmAPIservice, $interval, fileService, fileService2) {
        ...
        const populateLicence = (log, enableForm) => {
        ...
        $scope.updateRates = function(type) {
            ...
            if (type == 'hourly_rate') {
                ...
                $scope.empwork.annual_rate = (hours == 0) ? 0 : $scope.empwork.weekly_rate * 52; 
            } else if (type == 'annual_rate') {
                $scope.empwork.weekly_rate = (hours == 0) ? 0 : ($scope.empwork.annual_rate / 52);
                ...
                $scope.empwork.weekly_rate = (rate == 0) ? 0 : ($scope.empwork.hours_week * rate);
                $scope.empwork.annual_rate = (rate == 0) ? 0 : ($scope.empwork.hours_week * rate * 52); 
