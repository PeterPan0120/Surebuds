...
?>
  ...
  <div class="row">
    <div class="col-md-3 ">              
       <img style="width: 100%; height: 100%;"src="<?php echo FunctionsV3::getFoodDefaultImage($data['photo']);?>" alt="<?php echo $data['item_name']?>" title="<?php echo $data['item_name']?>">
    </div> <!--col-->
    <div class="col-md-9">
        <div class="container">
           <h3 class="bold"><?php echo qTranslate($data['item_name'],'item_name',$data)?></h3>
