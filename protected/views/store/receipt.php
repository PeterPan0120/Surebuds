...
if (is_array($data) && count($data)>=1){
	...
	if ( $json_details !=false){
		Yii::app()->functions->displayOrderHTML(array(
		  ...
		  'delivery_charge'=>isset($_SESSION['delivery_fee'])?$_SESSION['delivery_fee']:$data['delivery_charge'],
	    ...
	    <tbody>	     
	       ...
	       <?php if ($data['trans_type']=="delivery"):?>
		       ...
		       <tr>
			    ...
			    <tr>
		         <td><?php echo Yii::t("default","City")?></td>
		         <td class="text-right"><?php echo $data['city']?></td>
		       </tr>
		       <?php 	       
				$print[]=array(
				  'label'=>Yii::t("default","City"),
				  'value'=>$data['city']
				);
				?>
		   ...
		   <?php else :?>   
		      ...
		      <?php if (isset($_SESSION['kr_delivery_options']['delivery_date'])):?>		       
		       <tr>
		         ...
		         <td class="text-right">
		         <?php echo prettyDate($_SESSION['kr_delivery_options']['delivery_date'])?>
		         </td>
		       </tr>
		       <?php 	       
				$print[]=array(
				  'label'=>$label_date,
				  'value'=>prettyDate($_SESSION['kr_delivery_options']['delivery_date'])
				);
				?>
		       <?php endif;?>
