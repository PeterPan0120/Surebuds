...
function load_originalsales_chart()
{
	$.jqplot.config.enablePlugins = true;
	var ajaxDataRenderer = function(url, plot, options) {
    var ret = null;
    ...
    var jsonurl = ajax_url+"/?action=chartOriginalSales&tbl=chart&currentController="+$("#currentController").val();    
    
    jsonurl+= addValidationRequest();	
          
    var plot1 = $.jqplot('original_sales_chart', jsonurl,{
     animate: true,
     title: js_lang.lastOriginalSales ,
     seriesDefaults:{
            renderer:$.jqplot.BarRenderer,
            pointLabels: { show: true },
            rendererOptions:{  varyBarColor: true }
